...
SASA = pickle.load(open("FreeSASA/SASABALOSCTdb.dat","rb"))
MD = pickle.load(open("ModellerBALOSCTdb/DIST.dat","rb"))
MDCARBON = pickle.load(open("ModellerBALOSCTdb/DISTCARBON.dat","rb"))
MDALPHA = pickle.load(open("ModellerBALOSCTdb/DISTRESIDUE.dat","rb"))
PROPKA = pickle.load(open("Propka/PropkaBALOSCTdb.dat","rb"))
PSSM = pickle.load(open("PSSM/PSSMBALOSCTdb.dat","rb"))
SS = pickle.load(open("SecondaryStructure/SSBALOSCTdb.dat","rb"))
...
np.savetxt("BALOSCTdbMCCThresh.csv",np.stack((Xthresh,Ymcc),axis=-1),delimiter=",")
